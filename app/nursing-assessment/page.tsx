...
import { Stethoscope, Syringe, Beaker, ClipboardCheck, FileText, Activity, UserCircle } from "lucide-react"
      ...
      <div className="flex-1 ml-64">
        ...
        <main className="p-8">
          <div className="max-w-7xl mx-auto space-y-6">
            {/* Header */}
            <div>
              <h1 className="text-3xl font-bold tracking-tight">Nursing Assessment</h1>
              <p className="text-muted-foreground mt-2">SAMHSA and 42 CFR compliant nursing documentation system</p>
            </div>

            {/* Outer tabs to select between Initial Assessment and Progress Notes */}
            <Tabs defaultValue="initial-assessment" className="space-y-6">
              <TabsList className="grid w-full grid-cols-2 max-w-md">
                <TabsTrigger value="initial-assessment">
                      ...
                      <Card>
                        ...
                        <CardContent className="space-y-6">
                          ...
                          <div className="flex gap-3">
                            <Button className="flex-1" onClick={() => setIsSaving(true)}>
                      ...
                      <div className="grid gap-6">
                        <Card>
                          ...
                          <CardContent className="space-y-6">
                            ...
                            <Button className="w-full" onClick={() => setIsSaving(true)}>
                      ...
                      <div className="space-y-6">
                        <Card>
                          <CardHeader>
                            ...
                            <CardDescription>
                              Return visit to review and document Hepatitis test results
                            </CardDescription>
                          </CardHeader>
                          <CardContent className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                              ...
                              <div className="space-y-2">
                                ...
                                <Select>
                                  ...
                                  <SelectContent>
                                    <SelectItem value="pending">Pending</SelectItem>
                                    <SelectItem value="negative">Negative</SelectItem>
                                    <SelectItem value="positive-antibody">
                                      Positive Antibody (needs RNA test)
                                    </SelectItem>
                        ...
                        <Card>
                          ...
                          <CardContent className="space-y-6">
                            ...
                            <div className="space-y-2">
                              ...
                              <Textarea
                                rows={3}
                                placeholder="Document findings, patient risk factors, follow-up plan..."
                              />
                            </div>
              ...
              <TabsContent value="progress-note">
                <Card>
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2">
                      <UserCircle className="h-5 w-5" />
                ...
                {selectedPatient && (
                  <Card>
                    <CardHeader>
                      <CardTitle>Nursing Progress Note</CardTitle>
                      <CardDescription>Document follow-up nursing assessment and interventions</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      <div className="space-y-4">
                        <div className="space-y-2">
                          ...
                          <Select>
                            ...
                            <SelectContent>
                              ...
                              <SelectItem value="med-management">Medication Management</SelectItem>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            ...
                            <div className="space-y-2">
                              <Label className="text-sm">O2 Sat (%)</Label>
                              <Input type="number" />
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="space-y-2">
                          <Label>Subjective (Patient Report)</Label>
                          <Textarea
                            rows={3}
                            placeholder="Document patient's reported symptoms, concerns, or complaints..."
                          />
                        </div>

                        <div className="space-y-2">
                          <Label>Objective (Clinical Findings)</Label>
                          <Textarea rows={3} placeholder="Document objective findings and observations..." />
                        </div>

                        <div className="space-y-2">
                          <Label>Assessment (Clinical Impression)</Label>
                          <Textarea rows={3} placeholder="Document your clinical assessment and evaluation..." />
                        </div>

                        <div className="space-y-2">
                          <Label>Plan (Interventions & Follow-up)</Label>
                          <Textarea
                            rows={3}
                            placeholder="Document planned interventions, treatments, and follow-up..."
                          />
                        </div>

                        <div className="space-y-2">
                          <Label>Medications Administered</Label>
                          <Textarea rows={2} placeholder="List any medications administered during this visit..." />
                        </div>

                        <div className="space-y-2">
                          <Label>Patient Education Provided</Label>
                          <Textarea rows={2} placeholder="Document any education or counseling provided..." />
                        </div>
                      </div>
