...
export function PrescriptionDrugSearch({ onSelectDrug }: { onSelectDrug?: (drug: DrugSearchResult) => void }) {
      ...
      setSearchResults([
        {
          ...
          warnings: ["Monitor liver function", "Muscle pain may indicate rhabdomyolysis"],
        },
        {
          ndc: "0093-0155-01",
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Search for medications by brand name, generic name, or NDC number</CardDescription>
        </CardHeader>
      ...
      {searchResults.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>{searchResults.length} medications found</CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium flex items-center gap-2">
                        {drug.brand_name}
                        {drug.is_generic && <Badge variant="outline">Generic</Badge>}
                        {drug.dea_schedule && <Badge variant="destructive">Schedule {drug.dea_schedule}</Badge>}
                      </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <DialogTrigger asChild>
                        <Button variant="outline" size="sm" onClick={() => setSelectedDrug(drug)}>
                      ...
                      <DialogContent className="max-w-2xl">
                        ...
                        <div className="space-y-4">
                          <div>
                            <h4 className="font-medium mb-2">Drug Information</h4>
                            <div className="grid grid-cols-2 gap-4 text-sm">
                              <div>
                                <span className="font-medium">Manufacturer:</span> {drug.manufacturer}
                              </div>
                              <div>
                                <span className="font-medium">Route:</span> {drug.route}
                              </div>
                              <div>
                                <span className="font-medium">Form:</span> {drug.dosage_form}
                              </div>
                              <div>
